...
// ADICIONE ESTE PROTÓTIPO EM ssd1306.h

esp_err_t ssd1306_print_str_16x32(i2c_ssd1306_handle_t *i2c_ssd1306, uint8_t x, uint8_t y, const char *text, bool invert);
